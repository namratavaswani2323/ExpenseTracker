...
const Analytics = ({ allTransaction }) => {
    //category
    const categories= ['salary','tip','bills',
    'fees','medical','project','food','rent','tax','bonus','misc'];
                    ...
                    <div className='card'>
                        ...
                        <div className='card-body'>
                            <h5 className='text-success'>
                                Income: {totalIncomeTransaction.length} </h5>
                            <h5 className='text-danger'>
                                Expense: {totalExpenseTransaction.length} </h5>
                            <div>
